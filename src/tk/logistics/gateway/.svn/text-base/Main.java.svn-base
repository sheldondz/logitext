...
//	public static final String PREFS_NAME = "KalPrefsFile";
	...
	public void onResume() {
		...
		infoText += "<br /><br />For SMS polling all sms are fetched from <b>" + this.targetUrl ;
		infoText += "</b> and then sent to the users";
		infoText += "<br /><b>The polling feature may utilize more battery power.</b>" ;
